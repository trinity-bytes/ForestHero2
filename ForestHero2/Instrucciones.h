...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->botonRegresar->Location = System::Drawing::Point(47, 612);
			this->botonRegresar->Name = L"botonRegresar";
			this->botonRegresar->Size = System::Drawing::Size(121, 111);
			this->botonRegresar->TabIndex = 0;
			this->botonRegresar->UseVisualStyleBackColor = true;
			this->botonRegresar->Click += gcnew System::EventHandler(this, &Instrucciones::botonRegresar_Click);
			this->botonRegresar->MouseEnter += gcnew System::EventHandler(this, &Instrucciones::botonRegresar_MouseEnter);
			this->botonRegresar->MouseLeave += gcnew System::EventHandler(this, &Instrucciones::botonRegresar_MouseLeave);
			// 
			// Instrucciones
			// 
